...
class LoopMailComposeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextViewDelegate, WKNavigationDelegate, KeyboardHandler {
	...
	func keyboardUpdated(to keyboardEndFrame: CGRect) -> UIView {
		composeTableView.contentInset = UIEdgeInsets(top: composeTableView.contentInset.top, left: composeTableView.contentInset.left, bottom: composeTableView.frame.maxY - keyboardEndFrame.minY, right: composeTableView.contentInset.right)
		composeTableView.scrollIndicatorInsets = UIEdgeInsets(top: composeTableView.scrollIndicatorInsets.top, left: composeTableView.scrollIndicatorInsets.left, bottom: composeTableView.frame.maxY - keyboardEndFrame.minY, right: composeTableView.scrollIndicatorInsets.right)
		composeTableView.flashScrollIndicators()
		return composeTableView
	}
